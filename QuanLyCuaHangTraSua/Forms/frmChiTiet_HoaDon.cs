...
namespace QuanLyCuaHangTraSua.Forms
{
    public partial class frmChiTiet_HoaDon : Form
    {
        ...
        {
            if (id == 0 && dgvChiTietHoaDon.Rows.Count == 0) // Thêm
            {
            ...
            btnLuuHoaDon.Enabled = dgvChiTietHoaDon.Rows.Count > 0;
            btnXoa.Enabled = dgvChiTietHoaDon.Rows.Count > 0;
        }
        ...
        private void frmChiTiet_HoaDon_Load(object sender, EventArgs e)
        {
            ...
            dgvChiTietHoaDon.DataSource = hoaDonChiTiet;
        ...
        private void cboSanPham_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            numDonGiaBan.Value = sanPham.Gia;
        }
        ...
        private void dgvChiTietHoaDon_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                numDonGiaBan.Value = Convert.ToDecimal(row.Cells["DonGia"].Value);
                numSoLuongBan.Value = Convert.ToDecimal(row.Cells["SoLuong"].Value);

                cboSanPham.SelectedValue = row.Cells["SanPhamID"].Value; //
            }
        }
